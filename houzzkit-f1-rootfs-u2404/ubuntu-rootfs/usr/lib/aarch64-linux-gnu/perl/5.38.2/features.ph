...
unless(defined(&_FEATURES_H)) {
    ...
    undef(&__GLIBC_USE_C2X_STRTOL) if defined(&__GLIBC_USE_C2X_STRTOL);
    ...
    if( &__GLIBC_USE ((defined(&ISOC2X) ? &ISOC2X : undef))) {
	eval 'sub __GLIBC_USE_C2X_STRTOL () {1;}' unless defined(&__GLIBC_USE_C2X_STRTOL);
    } else {
	eval 'sub __GLIBC_USE_C2X_STRTOL () {0;}' unless defined(&__GLIBC_USE_C2X_STRTOL);
    }
    ...
    eval 'sub __GLIBC_MINOR__ () {39;}' unless defined(&__GLIBC_MINOR__);
